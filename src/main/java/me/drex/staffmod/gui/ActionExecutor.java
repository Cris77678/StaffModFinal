...
public class ActionExecutor {
    ...
    private static void logHistory(ServerPlayer staff, String actionType, ServerPlayer target, String detail) {
        ...
        StaffModAsync.runAsync(() -> {
            DatabaseManager.logAudit(staffName, staffUuid, actionType, targetName, targetUuid, detail);
        });
    ...
    public static void unmute(ServerPlayer staff, ServerPlayer target) {
        ...
        AuditLogManager.log(staff.getName().getString(), "UNMUTE", target.getName().getString(), "");
    }
    ...
    public static void unjail(ServerPlayer staff, ServerPlayer target) {
        ...
        target.teleportTo(overworld, spawn.getX(), spawn.getY(), spawn.getZ(), target.getYRot(), target.getXRot());
        ...
        AuditLogManager.log(staff.getName().getString(), "UNJAIL", target.getName().getString(), "");
    }
    ...
    public static void unban(ServerPlayer staff, ServerPlayer target) {
        ...
        DataStore.saveAsync();
        staff.sendSystemMessage(Component.literal("§a[sᴛᴀꜰꜰ] Ban removido a " + target.getName().getString()));
        AuditLogManager.log(staff.getName().getString(), "UNBAN", target.getName().getString(), "");
    }
    ...
    public static void freeze(ServerPlayer staff, ServerPlayer target) {
        ...
        if (pd.frozen) {
            ...
            AuditLogManager.log(staff.getName().getString(), "FREEZE", target.getName().getString(), "");
        } else {
            ...
            AuditLogManager.log(staff.getName().getString(), "UNFREEZE", target.getName().getString(), "");
        }
    }
    ...
    public static void spy(ServerPlayer staff, ServerPlayer target) {
        ...
        AuditLogManager.log(staff.getName().getString(), "SPY", target.getName().getString(), "InvSpy abierto");
    }
    ...
    public static void teleport(ServerPlayer staff, ServerPlayer target) {
        ...
        AuditLogManager.log(staff.getName().getString(), "TELEPORT", target.getName().getString(), "");
    }
    ...
    public static void kill(ServerPlayer staff, ServerPlayer target) {
        ...
        AuditLogManager.log(staff.getName().getString(), "KILL", target.getName().getString(), "");
    }
